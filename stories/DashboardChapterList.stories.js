...
import DashboardChapterList from "./DashboardChapterList";

export default {
  title: "DashboardChapterList",
  component: DashboardChapterList,
};

const Template = (args) => <DashboardChapterList {...args} />;
