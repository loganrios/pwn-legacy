...
import DashboardWorksList from "./DashboardWorksList";

export default {
  title: "DashboardWorksList",
  component: DashboardWorksList,
  argTypes: {
    ...
    onAddChapter: { action: "A good story is never finished" },
  },
};

const Template = (args) => <DashboardWorksList {...args} />;
